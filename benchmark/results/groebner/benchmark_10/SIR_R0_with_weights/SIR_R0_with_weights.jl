...
ring, (In_4, S_3, In_3, S_2, In_2, aux_1, S_1, In_1, aux_0, S_0, In_0, z_aux, R_0, b_0, g_0) = polynomial_ring(
    QQ, 
    ["In_4", "S_3", "In_3", "S_2", "In_2", "aux_1", "S_1", "In_1", "aux_0", "S_0", "In_0", "z_aux", "R_0", "b_0", "g_0"], 
    ordering=:degrevlex
)
system = [
	-In_0 + 61627613,
