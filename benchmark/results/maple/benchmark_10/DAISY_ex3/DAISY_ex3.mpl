...
for i from 1 by 1 to 1 do
	...
	print("DAISY_ex3: ", time[real]() - st):
	runtime := min(runtime, time[real]() - st):
end do:

timings_fn := "/home/demin/Groebner.jl/benchmark/results/maple/benchmark_10/DAISY_ex3/timings":
FileTools[Text][WriteLine](timings_fn, "DAISY_ex3");
