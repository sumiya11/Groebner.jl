...
for i from 1 by 1 to 1 do
	...
	print("Running DAISY_mamil3_with_weights");
	st := time[real]():
	...
	print("DAISY_mamil3_with_weights: ", time[real]() - st):
	runtime := min(runtime, time[real]() - st):
end do:

timings_fn := "/home/demin/Groebner.jl/benchmark/results/maple/benchmark_10/DAISY_mamil3_with_weights/timings":
FileTools[Text][WriteLine](timings_fn, "DAISY_mamil3_with_weights");
