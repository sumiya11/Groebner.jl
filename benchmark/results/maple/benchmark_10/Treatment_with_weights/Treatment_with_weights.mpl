...
for i from 1 by 1 to 1 do
	J := [
		...
		-Tr_2 + 1302004934802039601345011160583523108201150031267201111934771092625/33197003141567,
		...
		-Tr_3 - 46910137255420535247291100108009892566890745065218348233559595077960064967779581605799188632819048648578375/1102041017581209267443215489,
		...
		-Tr_4 + 1690132593584790977795471367626034035142528579347822083538122989193366446421205809455377923808181291769620359173713642934989039956735780735060830625/36584459122779097530859279282113154131263,
		...
		N_3,
		-Tr_5 - 60894048728615432129759751945738489829168096447733413070313516781302052171579196270419446211520468590029644143595361372565940010331894701573148146803991555988475288208948249753114330584375/1214494404431427193703696587057303814165913095689509121,
		...
		N_4,
		-Tr_6 + ,
		...
		-Tr_7 - ,
		-N_1,
		-N_2,
		-N_3,
		-N_4,
	...
	print("Running Treatment_with_weights");
	st := time[real]():
	...
	print("Treatment_with_weights: ", time[real]() - st):
	runtime := min(runtime, time[real]() - st):
end do:

timings_fn := "/home/demin/Groebner.jl/benchmark/results/maple/benchmark_10/Treatment_with_weights/timings":
FileTools[Text][WriteLine](timings_fn, "Treatment_with_weights");
