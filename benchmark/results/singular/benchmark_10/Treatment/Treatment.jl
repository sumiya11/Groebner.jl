...
ring, (Tr_7, In_6, Tr_6, In_5, Tr_5, S_5, N_5, In_4, Tr_4, S_4, N_4, In_3, Tr_3, S_3, N_3, In_2, Tr_2, S_2, N_2, In_1, Tr_1, S_1, N_1, In_0, Tr_0, S_0, N_0, z_aux, b_0, d_0, a_0, g_0, nu_0) = polynomial_ring(
    QQ, 
    ["Tr_7", "In_6", "Tr_6", "In_5", "Tr_5", "S_5", "N_5", "In_4", "Tr_4", "S_4", "N_4", "In_3", "Tr_3", "S_3", "N_3", "In_2", "Tr_2", "S_2", "N_2", "In_1", "Tr_1", "S_1", "N_1", "In_0", "Tr_0", "S_0", "N_0", "z_aux", "b_0", "d_0", "a_0", "g_0", "nu_0"], 
    ordering=:degrevlex
)
system = [
	-Tr_0 + 27932493965905,
