...
systems = [
    # ("kat5", Groebner.katsuran(5, internal_ordering=:degrevlex, k=QQ)),
    ("kat6", Groebner.katsuran(6, internal_ordering=:degrevlex, k=QQ)),
    ("kat7", Groebner.katsuran(7, internal_ordering=:degrevlex, k=QQ)),
    ("kat8", Groebner.katsuran(8, internal_ordering=:degrevlex, k=QQ)),
    ("kat9", Groebner.katsuran(9, internal_ordering=:degrevlex, k=QQ)),
    ("kat10", Groebner.katsuran(10, internal_ordering=:degrevlex, k=QQ)),
    # ("kat11", Groebner.katsuran(11, internal_ordering=:degrevlex, k=QQ)),
    # ("kat12", Groebner.katsuran(12, internal_ordering=:degrevlex, k=QQ)),
    ("hen5", Groebner.henrion5(internal_ordering=:degrevlex, k=QQ)),
    ("hen6", Groebner.henrion6(internal_ordering=:degrevlex, k=QQ)),
    ("reim4", Groebner.reimern(4, internal_ordering=:degrevlex, k=QQ)),
    # ("reim5", Groebner.reimern(5, internal_ordering=:degrevlex, k=QQ)),
    # ("cyc4", Groebner.cyclicn(4, internal_ordering=:degrevlex, k=QQ)),
    # ("cyc5", Groebner.cyclicn(5, internal_ordering=:degrevlex, k=QQ)),
    ("cyc6", Groebner.cyclicn(6, internal_ordering=:degrevlex, k=QQ)),
    ("cyc7", Groebner.cyclicn(7, internal_ordering=:degrevlex, k=QQ)),
    ("cyc8", Groebner.cyclicn(8, internal_ordering=:degrevlex, k=QQ)),
    ("eco10", Groebner.eco10(internal_ordering=:degrevlex, k=QQ)),
    ("eco11", Groebner.eco11(internal_ordering=:degrevlex, k=QQ)),
    ("eco12", Groebner.eco12(internal_ordering=:degrevlex, k=QQ)),
    # ("eco13", Groebner.eco13(internal_ordering=:degrevlex, k=QQ)),
    # ("noon4", Groebner.noonn(4, internal_ordering=:degrevlex, k=QQ)),
    ("noon5", Groebner.noonn(5, internal_ordering=:degrevlex, k=QQ)),
    ("noon6", Groebner.noonn(6, internal_ordering=:degrevlex, k=QQ)),
    ("noon7", Groebner.noonn(7, internal_ordering=:degrevlex, k=QQ)),
    ("noon8", Groebner.noonn(8, internal_ordering=:degrevlex, k=QQ)),
    ("hexapod", hexapod)
]
