...
systems = [
    # ("kat5", Groebner.katsuran(5, ordering=:degrevlex, k=QQ)),
    ("kat6", Groebner.katsuran(6, ordering=:degrevlex, k=QQ)),
    ("kat7", Groebner.katsuran(7, ordering=:degrevlex, k=QQ)),
    ("kat8", Groebner.katsuran(8, ordering=:degrevlex, k=QQ)),
    ("kat9", Groebner.katsuran(9, ordering=:degrevlex, k=QQ)),
    ("kat10", Groebner.katsuran(10, ordering=:degrevlex, k=QQ)),
    # ("kat11", Groebner.katsuran(11, ordering=:degrevlex, k=QQ)),
    # ("kat12", Groebner.katsuran(12, ordering=:degrevlex, k=QQ)),
    ("hen5", Groebner.henrion5(ordering=:degrevlex, k=QQ)),
    ("hen6", Groebner.henrion6(ordering=:degrevlex, k=QQ)),
    ("reim4", Groebner.reimern(4, ordering=:degrevlex, k=QQ)),
    # ("reim5", Groebner.reimern(5, ordering=:degrevlex, k=QQ)),
    # ("cyc4", Groebner.cyclicn(4, ordering=:degrevlex, k=QQ)),
    # ("cyc5", Groebner.cyclicn(5, ordering=:degrevlex, k=QQ)),
    ("cyc6", Groebner.cyclicn(6, ordering=:degrevlex, k=QQ)),
    ("cyc7", Groebner.cyclicn(7, ordering=:degrevlex, k=QQ)),
    ("cyc8", Groebner.cyclicn(8, ordering=:degrevlex, k=QQ)),
    ("eco10", Groebner.eco10(ordering=:degrevlex, k=QQ)),
    ("eco11", Groebner.eco11(ordering=:degrevlex, k=QQ)),
    ("eco12", Groebner.eco12(ordering=:degrevlex, k=QQ)),
    # ("eco13", Groebner.eco13(ordering=:degrevlex, k=QQ)),
    # ("noon4", Groebner.noonn(4, ordering=:degrevlex, k=QQ)),
    ("noon5", Groebner.noonn(5, ordering=:degrevlex, k=QQ)),
    ("noon6", Groebner.noonn(6, ordering=:degrevlex, k=QQ)),
    ("noon7", Groebner.noonn(7, ordering=:degrevlex, k=QQ)),
    ("noon8", Groebner.noonn(8, ordering=:degrevlex, k=QQ)),
    ("hexapod", hexapod)
]
