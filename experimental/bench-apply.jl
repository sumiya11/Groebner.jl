...
systems = [
    # ("kat5", Groebner.katsuran(5, ordering=:degrevlex, ground=QQ)),
    ("kat6", Groebner.katsuran(6, ordering=:degrevlex, ground=QQ)),
    ("kat7", Groebner.katsuran(7, ordering=:degrevlex, ground=QQ)),
    ("kat8", Groebner.katsuran(8, ordering=:degrevlex, ground=QQ)),
    ("kat9", Groebner.katsuran(9, ordering=:degrevlex, ground=QQ)),
    ("kat10", Groebner.katsuran(10, ordering=:degrevlex, ground=QQ)),
    # ("kat11", Groebner.katsuran(11, ordering=:degrevlex, ground=QQ)),
    # ("kat12", Groebner.katsuran(12, ordering=:degrevlex, ground=QQ)),
    ("hen5", Groebner.henrion5(ordering=:degrevlex, ground=QQ)),
    ("hen6", Groebner.henrion6(ordering=:degrevlex, ground=QQ)),
    ("reim4", Groebner.reimern(4, ordering=:degrevlex, ground=QQ)),
    # ("reim5", Groebner.reimern(5, ordering=:degrevlex, ground=QQ)),
    # ("cyc4", Groebner.cyclicn(4, ordering=:degrevlex, ground=QQ)),
    # ("cyc5", Groebner.cyclicn(5, ordering=:degrevlex, ground=QQ)),
    ("cyc6", Groebner.cyclicn(6, ordering=:degrevlex, ground=QQ)),
    ("cyc7", Groebner.cyclicn(7, ordering=:degrevlex, ground=QQ)),
    ("cyc8", Groebner.cyclicn(8, ordering=:degrevlex, ground=QQ)),
    ("eco10", Groebner.eco10(ordering=:degrevlex, ground=QQ)),
    ("eco11", Groebner.eco11(ordering=:degrevlex, ground=QQ)),
    ("eco12", Groebner.eco12(ordering=:degrevlex, ground=QQ)),
    # ("eco13", Groebner.eco13(ordering=:degrevlex, ground=QQ)),
    # ("noon4", Groebner.noonn(4, ordering=:degrevlex, ground=QQ)),
    ("noon5", Groebner.noonn(5, ordering=:degrevlex, ground=QQ)),
    ("noon6", Groebner.noonn(6, ordering=:degrevlex, ground=QQ)),
    ("noon7", Groebner.noonn(7, ordering=:degrevlex, ground=QQ)),
    ("noon8", Groebner.noonn(8, ordering=:degrevlex, ground=QQ)),
    ("hexapod", hexapod)
]
