...
systems = [
    # ("kat5", Groebner.katsuran(5, ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    # ("kat6", Groebner.katsuran(6, ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    # ("kat7", Groebner.katsuran(7, ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    ("kat8", Groebner.katsuran(8, ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    ("kat9", Groebner.katsuran(9, ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    ("kat10", Groebner.katsuran(10, ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    # ("kat11", Groebner.katsuran(11, ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    # ("kat12", Groebner.katsuran(12, ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    # ("hen5", Groebner.henrion5(ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    # ("reim4", Groebner.reimern(4, ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    # ("reim5", Groebner.reimern(5, ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    # ("cyc4", Groebner.cyclicn(4, ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    # ("cyc5", Groebner.cyclicn(5, ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    ("cyc6", Groebner.cyclicn(6, ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    ("cyc7", Groebner.cyclicn(7, ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    ("cyc8", Groebner.cyclicn(8, ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    ("eco10", Groebner.eco10(ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    ("eco11", Groebner.eco11(ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    # ("eco12", Groebner.eco12(ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    # ("eco13", Groebner.eco13(ordering=:degrevlex, ground=AbstractAlgebra.QQ))
    # ("noon4", Groebner.noonn(4, ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    # ("noon5", Groebner.noonn(5, ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    # ("noon6", Groebner.noonn(6, ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    ("noon7", Groebner.noonn(7, ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    ("noon8", Groebner.noonn(8, ordering=:degrevlex, ground=AbstractAlgebra.QQ)),
    ("hexapod", hexapod)
]
