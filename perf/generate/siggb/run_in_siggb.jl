...
const BENCHMARK_DIR = "../../" * get_benchmark_dir("siggb", BENCHMARK_SET)
...
# Compile
system_hom = AlgebraicSolving._homogenize(system)
timing = @timed result = AlgebraicSolving.sig_groebner_basis(system_hom)
