...
for (name, sys) in systems
    ...
    for kws in [
      ...
      elseif kws == 3
        ...
        push!(timers, [name, opt, copy(Groebner._TIMER), Groebner._LINALG_MOD_P[], Groebner._LINALG_ADDMUL_MOD_P[], Groebner._LINALG_MUL_MOD_P[], Groebner._LINALG_REDUCE_ROW[]])
    end    
end
...
labels2 = ["Name", "Options", "% p", "addmul % p", "mul % p", "rows reduced"]
data = []
data2 = []
for entry in timers
    name = entry[1]
