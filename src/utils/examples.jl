...
# Parameter estimation in NFkB from: https://github.com/SciML/StructuralIdentifiability.jl/blob/9345c59e0b649b9ad8baf6de6b44d129c737237c/examples/NFkB.jl
# Produced using the code from https://github.com/iliailmer/ParameterEstimation.jl
# with some parameters replaced with numbers.
function NFkB_reduced(; np=AbstractAlgebra, internal_ordering=:degrevlex, k=np.QQ)
    R, (i1_0,i1a_0,k_prod_0,t1_0,t2_0,u_0,u_1,u_2,u_3,x10_0,x10_1,x10_2,x10_3,x10_4,x11_0,x11_1,x11_2,x11_3,x11_4,x12_0,x12_1,x12_2,x12_3,x13_0,x13_1,x13_2,x13_3,x13_4,x14_0,x14_1,x14_2,x14_3,x1_0,x1_1,x1_2,x1_3,x1_4,x2_0,x2_1,x2_2,x2_3,x2_4,x3_0,x3_1,x3_2,x3_3,x3_4,x4_0,x4_1,x4_2,x4_3,x5_0,x5_1,x5_2,x5_3,x6_0,x6_1,x6_2,x6_3,x6_4,x7_0,x7_1,x7_2,x7_3,x7_4,x7_5,x8_0,x8_1,x8_2,x8_3,x9_0,x9_1,x9_2) = np.polynomial_ring(k, ["i1_0","i1a_0","k_prod_0","t1_0","t2_0","u_0","u_1","u_2","u_3","x10_0","x10_1","x10_2","x10_3","x10_4","x11_0","x11_1","x11_2","x11_3","x11_4","x12_0","x12_1","x12_2","x12_3","x13_0","x13_1","x13_2","x13_3","x13_4","x14_0","x14_1","x14_2","x14_3","x1_0","x1_1","x1_2","x1_3","x1_4","x2_0","x2_1","x2_2","x2_3","x2_4","x3_0","x3_1","x3_2","x3_3","x3_4","x4_0","x4_1","x4_2","x4_3","x5_0","x5_1","x5_2","x5_3","x6_0","x6_1","x6_2","x6_3","x6_4","x7_0","x7_1","x7_2","x7_3","x7_4","x7_5","x8_0","x8_1","x8_2","x8_3","x9_0","x9_1","x9_2"], internal_ordering=internal_ordering)

    sys = [
        -x7_0 + 1087917959349171//k(1125899906842624),k(-1)//k(10)*i1_0*x6_0 + k(1)//k(10)*x11_0*x7_0 + x7_1,-x9_0 + k(8617739573352685)//k(9007199254740992), k(1)//k(10)*x7_0 + k(1)//k(10)*x9_0 + x9_1 - k(1)//k(10),-x1_0 - x2_0 - x3_0 + k(7627910363403261)//k(2251799813685248),        k(1)//k(10)*u_0*x2_0*x8_0 - k(1)//k(10)*u_0*x1_0 + k(1)//k(10)*x10_0*x2_0 + k(1)//k(10)*x13_0*x2_0 - t1_0*x4_0 - t2_0*x5_0 + k(1)//k(5)*x2_0 + x2_1,
        k(1)//k(10)*u_0*x1_0 - k_prod_0 + k(1)//k(10)*x1_0 + x1_1,k(-1)//k(10)*u_0*x2_0*x8_0 - k(1)//k(10)*x2_0 + k(1)//k(10)*x3_0 + x3_1,-x10_0 - x13_0 + k(2059383086697551)//k(1125899906842624),k(1)//k(10)*x13_0*x2_0 - k(1)//k(10)*x10_0*x6_0 + k(1)//k(10)*x13_0 + x13_1 - k(1)//k(10)*x14_0,i1a_0*x10_0 + k(1)//k(10)*x10_0*x2_0 + k(1)//k(10)*x10_0*x6_0 + k(1)//k(10)*x10_0 + x10_1 - k(1)//k(10)*x11_0 - k(1)//k(10)*x12_0,-x2_0 + k(2801824555072859)//k(2251799813685248),-x12_0 + k(4698329468064649)//k(4503599627370496),k(1)//k(10)*x12_0 + x12_1 - k(1)//k(10)*x7_0 - k(1)//k(10),-u_0 + k(6530219459687117)//k(4503599627370496),
        u_1 - k(1),-x7_1 - k(1265874459032373)//k(18014398509481984), k(-1)//k(10)*i1_0*x6_1 + k(1)//k(10)*x11_1*x7_0 + k(1)//k(10)*x11_0*x7_1 + x7_2,-t2_0*x5_0 + i1_0*x6_0 + k(1)//k(10)*x10_0*x6_0 - k(1)//k(10)*x13_0 + x6_1, k(-1)//k(10)*i1a_0*x10_0 + k(1)//k(10)*x11_0*x7_0 + k(27191544919973)//k(2719154491997299)*x11_0 + x11_1,-x1_1 - x2_1 - x3_1 + k(6653335799572365)//k(9007199254740992), k(1)//k(10)*u_1*x1_0 + k(1)//k(10)*u_0*x1_1 + k(1)//k(10)*x1_1 + x1_2, k(1)//k(10)*u_1*x2_0*x8_0 + k(1)//k(10)*u_0*x2_1*x8_0 + k(1)//k(10)*u_0*x2_0*x8_1 - k(1)//k(10)*u_1*x1_0 - k(1)//k(10)*u_0*x1_1 + k(1)//k(10)*x10_1*x2_0 + k(1)//k(10)*x13_1*x2_0 + k(1)//k(10)*x10_0*x2_1 + k(1)//k(10)*x13_0*x2_1 - t1_0*x4_1 - t2_0*x5_1 + k(1)//k(5)*x2_1 + x2_2, k(-1)//k(10)*u_1*x2_0*x8_0 - k(1)//k(10)*u_0*x2_1*x8_0 - k(1)//k(10)*u_0*x2_0*x8_1 - k(1)//k(10)*x2_1 + k(1)//k(10)*x3_1 + x3_2,
        k(1)//k(10)*x8_0 + x8_1 - k(1)//k(10)*x9_0,k(-1)//k(10)*x13_0*x2_0 + t2_0*x5_0 + x5_1,
        k(-1)//k(10)*x10_0*x2_0 + t1_0*x4_0 + x4_1,-x10_1 - x13_1 - k(1604424493326049)//k(4503599627370496),
        i1a_0*x10_1 + k(1)//k(10)*x10_1*x2_0 + k(1)//k(10)*x10_0*x2_1 + k(1)//k(10)*x10_1*x6_0 + k(1)//k(10)*x10_0*x6_1 + k(1)//k(10)*x10_1 + x10_2 - k(1)//k(10)*x11_1 - k(1)//k(10)*x12_1,
        k(1)//k(10)*x13_1*x2_0 + k(1)//k(10)*x13_0*x2_1 - k(1)//k(10)*x10_1*x6_0 - k(1)//k(10)*x10_0*x6_1 + k(1)//k(10)*x13_1 + x13_2 - k(1)//k(10)*x14_1,
        k(-1)//k(10)*x11_0*x7_0 + k(27191544919973)//k(2719154491997299)*x14_0 + x14_1,-x2_1 + k(7283230198371657)//k(18014398509481984),-x7_2 + k(5615679340511373)//k(288230376151711744),
        k(-1)//k(10)*i1_0*x6_2 + k(1)//k(10)*x11_2*x7_0 + k(1)//k(5)*x11_1*x7_1 + k(1)//k(10)*x11_0*x7_2 + x7_3,
        -t2_0*x5_1 + k(1)//k(10)*x10_1*x6_0 + i1_0*x6_1 + k(1)//k(10)*x10_0*x6_1 - k(1)//k(10)*x13_1 + x6_2,
        k(-1)//k(10)*i1a_0*x10_1 + k(1)//k(10)*x11_1*x7_0 + k(1)//k(10)*x11_0*x7_1 + k(27191544919973)//k(2719154491997299)*x11_1 + x11_2,
        -x1_2 - x2_2 - x3_2 - k(2154146894998627)//k(4503599627370496),
        k(-1)//k(10)*u_2*x2_0*x8_0 - k(1)//k(5)*u_1*x2_1*x8_0 - k(1)//k(10)*u_0*x2_2*x8_0 - k(1)//k(5)*u_1*x2_0*x8_1 - k(1)//k(5)*u_0*x2_1*x8_1 - k(1)//k(10)*u_0*x2_0*x8_2 - k(1)//k(10)*x2_2 + k(1)//k(10)*x3_2 + x3_3,
        k(1)//k(10)*u_2*x2_0*x8_0 + k(1)//k(5)*u_1*x2_1*x8_0 + k(1)//k(10)*u_0*x2_2*x8_0 + k(1)//k(5)*u_1*x2_0*x8_1 + k(1)//k(5)*u_0*x2_1*x8_1 + k(1)//k(10)*u_0*x2_0*x8_2 - k(1)//k(10)*u_2*x1_0 - k(1)//k(5)*u_1*x1_1 - k(1)//k(10)*u_0*x1_2 + k(1)//k(10)*x10_2*x2_0 + k(1)//k(10)*x13_2*x2_0 + k(1)//k(5)*x10_1*x2_1 + k(1)//k(5)*x13_1*x2_1 + k(1)//k(10)*x10_0*x2_2 + k(1)//k(10)*x13_0*x2_2 - t1_0*x4_2 - t2_0*x5_2 + k(1)//k(5)*x2_2 + x2_3,
        k(1)//k(10)*u_2*x1_0 + k(1)//k(5)*u_1*x1_1 + k(1)//k(10)*u_0*x1_2 + k(1)//k(10)*x1_2 + x1_3,
        u_2,
        1//k(10)*x8_1 + x8_2 - 1//k(10)*x9_1,-1//k(10)*x13_1*x2_0 - 1//k(10)*x13_0*x2_1 + t2_0*x5_1 + x5_2,-1//k(10)*x10_1*x2_0 - 1//k(10)*x10_0*x2_1 + t1_0*x4_1 + x4_2,-x10_2 - x13_2 + 2081185062807031//k(18014398509481984),
        1//k(10)*x13_2*x2_0 + 1//k(5)*x13_1*x2_1 + 1//k(10)*x13_0*x2_2 - 1//k(10)*x10_2*x6_0 - 1//k(5)*x10_1*x6_1 - 1//k(10)*x10_0*x6_2 + 1//k(10)*x13_2 + x13_3 - 1//k(10)*x14_2,
        i1a_0*x10_2 + 1//k(10)*x10_2*x2_0 + 1//k(5)*x10_1*x2_1 + 1//k(10)*x10_0*x2_2 + 1//k(10)*x10_2*x6_0 + 1//k(5)*x10_1*x6_1 + 1//k(10)*x10_0*x6_2 + 1//k(10)*x10_2 + x10_3 - 1//k(10)*x11_2 - 1//k(10)*x12_2,
        1//k(10)*x12_1 + x12_2 - 1//k(10)*x7_1,-1//k(10)*x11_1*x7_0 - 1//k(10)*x11_0*x7_1 + 27191544919973//k(2719154491997299)*x14_1 + x14_2,
        -x2_2 - 76007005474747//k(140737488355328), -x7_3 - 4931190233469493//k(576460752303423488), -1//k(10)*i1_0*x6_3 + 1//k(10)*x11_3*x7_0 + 3//k(10)*x11_2*x7_1 + 3//k(10)*x11_1*x7_2 + 1//k(10)*x11_0*x7_3 + x7_4, -1//k(10)*i1a_0*x10_2 + 1//k(10)*x11_2*x7_0 + 1//k(5)*x11_1*x7_1 + 1//k(10)*x11_0*x7_2 + 27191544919973//k(2719154491997299)*x11_2 + x11_3, -t2_0*x5_2 + 1//k(10)*x10_2*x6_0 + 1//k(5)*x10_1*x6_1 + i1_0*x6_2 + 1//k(10)*x10_0*x6_2 - 1//k(10)*x13_2 + x6_3, -x1_3 - x2_3 - x3_3 + 3500819284168905//k(9007199254740992),
        -1//k(10)*u_3*x2_0*x8_0 - 3//k(10)*u_2*x2_1*x8_0 - 3//k(10)*u_1*x2_2*x8_0 - 1//k(10)*u_0*x2_3*x8_0 - 3//k(10)*u_2*x2_0*x8_1 - 3//k(5)*u_1*x2_1*x8_1 - 3//k(10)*u_0*x2_2*x8_1 - 3//k(10)*u_1*x2_0*x8_2 - 3//k(10)*u_0*x2_1*x8_2 - 1//k(10)*u_0*x2_0*x8_3 - 1//k(10)*x2_3 + 1//k(10)*x3_3 + x3_4,
        1//k(10)*u_3*x2_0*x8_0 + 3//k(10)*u_2*x2_1*x8_0 + 3//k(10)*u_1*x2_2*x8_0 + 1//k(10)*u_0*x2_3*x8_0 + 3//k(10)*u_2*x2_0*x8_1 + 3//k(5)*u_1*x2_1*x8_1 + 3//k(10)*u_0*x2_2*x8_1 + 3//k(10)*u_1*x2_0*x8_2 + 3//k(10)*u_0*x2_1*x8_2 + 1//k(10)*u_0*x2_0*x8_3 - 1//k(10)*u_3*x1_0 - 3//k(10)*u_2*x1_1 - 3//k(10)*u_1*x1_2 - 1//k(10)*u_0*x1_3 + 1//k(10)*x10_3*x2_0 + 1//k(10)*x13_3*x2_0 + 3//k(10)*x10_2*x2_1 + 3//k(10)*x13_2*x2_1 + 3//k(10)*x10_1*x2_2 + 3//k(10)*x13_1*x2_2 + 1//k(10)*x10_0*x2_3 + 1//k(10)*x13_0*x2_3 - t1_0*x4_3 - t2_0*x5_3 + 1//k(5)*x2_3 + x2_4,
        1//k(10)*u_3*x1_0 + 3//k(10)*u_2*x1_1 + 3//k(10)*u_1*x1_2 + 1//k(10)*u_0*x1_3 + 1//k(10)*x1_3 + x1_4,
        u_3,-1//k(10)*x10_2*x2_0 - 1//k(5)*x10_1*x2_1 - 1//k(10)*x10_0*x2_2 + t1_0*x4_2 + x4_3,-1//k(10)*x13_2*x2_0 - 1//k(5)*x13_1*x2_1 - 1//k(10)*x13_0*x2_2 + t2_0*x5_2 + x5_3,
        1//k(10)*x8_2 + x8_3 - 1//k(10)*x9_2,1//k(10)*x7_1 + 1//k(10)*x9_1 + x9_2,-x10_3 - x13_3 + 7413820825919623//k(144115188075855872),
        1//k(10)*x13_3*x2_0 + 3//k(10)*x13_2*x2_1 + 3//k(10)*x13_1*x2_2 + 1//k(10)*x13_0*x2_3 - 1//k(10)*x10_3*x6_0 - 3//k(10)*x10_2*x6_1 - 3//k(10)*x10_1*x6_2 - 1//k(10)*x10_0*x6_3 + 1//k(10)*x13_3 + x13_4 - 1//k(10)*x14_3,
        i1a_0*x10_3 + 1//k(10)*x10_3*x2_0 + 3//k(10)*x10_2*x2_1 + 3//k(10)*x10_1*x2_2 + 1//k(10)*x10_0*x2_3 + 1//k(10)*x10_3*x6_0 + 3//k(10)*x10_2*x6_1 + 3//k(10)*x10_1*x6_2 + 1//k(10)*x10_0*x6_3 + 1//k(10)*x10_3 + x10_4 - 1//k(10)*x11_3 - 1//k(10)*x12_3,
        1//k(10)*x12_2 + x12_3 - 1//k(10)*x7_2,-1//k(10)*x11_2*x7_0 - 1//k(5)*x11_1*x7_1 - 1//k(10)*x11_0*x7_2 + 27191544919973//k(2719154491997299)*x14_2 + x14_3,-x2_3 + 513728119802863//k(1125899906842624),-x7_4 + 6517251002848763//k(1152921504606846976),-1//k(10)*i1_0*x6_4 + 1//k(10)*x11_4*x7_0 + 2//k(5)*x11_3*x7_1 + 3//k(5)*x11_2*x7_2 + 2//k(5)*x11_1*x7_3 + 1//k(10)*x11_0*x7_4 + x7_5,-t2_0*x5_3 + 1//k(10)*x10_3*x6_0 + 3//k(10)*x10_2*x6_1 + 3//k(10)*x10_1*x6_2 + i1_0*x6_3 + 1//k(10)*x10_0*x6_3 - 1//k(10)*x13_3 + x6_4,
        -1//k(10)*i1a_0*x10_3 + 1//k(10)*x11_3*x7_0 + 3//k(10)*x11_2*x7_1 + 3//k(10)*x11_1*x7_2 + 1//k(10)*x11_0*x7_3 + 27191544919973//k(2719154491997299)*x11_3 + x11_4,
    ]
    return sys
end
