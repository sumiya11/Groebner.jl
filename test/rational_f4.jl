...
@testset "zz groebner modular" begin
    ...
    @test Groebner.groebner([(2^31 - 1)x * y + 2147483659x + 2147483693y]) ==
          [(2^31 - 1)x * y + 2147483659x + 2147483693y]
    @test Groebner.groebner([(2^30 + 3)x * y^2 + 1073741831x^2 + 1073741833y + 2^31 - 1]) ==
          [(2^30 + 3)x * y^2 + 1073741831x^2 + 1073741833y + 2^31 - 1]
